...
const DataUtama = ({ setActiveTab }) => {
                ...
                <form>
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-6">
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 text-sm bg-white">{data.nomor_pengajuan}</p>
                        ...
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 text-sm bg-white">{data.tanggal_pengajuan}</p>
    ...
    {data.nomor_pendaftaran ? data.nomor_pendaftaran : "Nomor Pendaftaran"}
</p>
                        ...
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 text-sm bg-white">
    {data.tanggal_pendaftaran ? data.tanggal_pendaftaran : "Tanggal Pendaftaran"}
</p>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 text-sm bg-white">{data.kd_skep_fasilitas}</p>
