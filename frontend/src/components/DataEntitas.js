        ...
        <div className="bg-gray-50 p-6 border border-gray-100 rounded-lg shadow-md">
            {data && (
                <div className="grid grid-cols-1 gap-6 text-sm">
                    ...
                    {/* Jenis Identitas, NIB, Nomor Identitas */}
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.nib}</p>
                        </div>
    ...
    <button className="p-2 mt-6 bg-gray-700 text-white rounded-md shadow ">
        ...
        >
            ...
            />
                    ...
                    {/* Nomor Identitas 16 Digit, Nama Perusahaan */}
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Nomor Identitas (16 Digit)</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.nomor_identitas}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Nama Perusahaan</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.nama_identitas}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-5 gap-4">
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.provinsi_identitas}</p>
                              <label className="block text-sm font-medium text-gray-700">Jenis Identitas</label>
                            <select
                        ...
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.kota_identitas}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Kecamatan</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.kecamatan}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Kode Pos</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.kode_pos}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">RT/RW</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.rt_rw}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.tlp_identitas}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Email</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.email_identitas}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Status</label>
                            <p className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white">{data.pengusaha.status}</p>
                        </div>
                    </div>
                </div>
            )}
